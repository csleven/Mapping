...
For some reason that I can't work out, when I try to make R 'knit HTML' this, it says that 'ggplot' cannot be found, and so doesn't display the plots, though the code does actually work in R...
